...
impl AnthropicClient {
    ...
    pub async fn summarize(&self, text: &str) -> Result<String> {
        info!("Summarizing text with Anthropic API");
        ...
        let request = AnthropicRequest {
            ...
            system: "You are a voice notification assistant for Claude Code, an AI coding assistant. When Claude Code finishes helping with a task, you summarize what was accomplished in a clear, informative sentence that will be read aloud as a voice notification.
